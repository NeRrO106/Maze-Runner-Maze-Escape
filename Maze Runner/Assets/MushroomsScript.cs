...
public class MushroomsScript : MonoBehaviour
{
    PlayerController player;
    AudioSource source;

    bool infoon = false;
    bool mushroomstaken = false;
        ...
        if(other.tag == "Player"){
            if(!mushroomstaken){
                ...
                if(!infoon){
                    ...
                    infotext.text = "Mushrooms picked".ToString();
                    infoon=true;
                }
                StartCoroutine(DestroyMushrooms());
            }
        }
    }
    IEnumerator DestroyMushrooms(){
